...
## Mục lục
  ...
  2. [Biến (variables)](#variables)
     * [Dùng tên có nghĩa và đánh vần được](#use-meaningful-and-pronounceable-variable-names)
     * [Dùng cùng ngữ pháp cho cùng kiểu biến](#use-the-same-vocabulary-for-the-same-type-of-variable)
     * [Sử dụng tên search được (phần 1)](#use-searchable-names-part-1)
     * [Sử dụng tên search được (phần 2)](#use-searchable-names-part-2)
     * [Sử dụng tên biến tự giải thích](#use-explanatory-variables)
     * [Hạn chế code nhiều tầng, nên return sớm (phần 1)](#avoid-nesting-too-deeply-and-return-early-part-1)
     * [Hạn chế code nhiều tầng, nên return sớm (phần 2)](#avoid-nesting-too-deeply-and-return-early-part-2)
     * [Tránh đặt tên biến khó hiểu (hơi giống cái tên biến tự giải thích)](#avoid-mental-mapping)
     * [Đừng dùng tiền tố/hậu tố thừa](#dont-add-unneeded-context)
     * [Nên dùng đối số (argument) mặc định, kết hợp với kiểu dữ liệu](#use-default-arguments-instead-of-short-circuiting-or-conditionals)
  3. [So sánh](#comparison)
     * [Sử dụng so sánh bằng tuyệt đối](#use-identical-comparison)
     * [Sử dụng toán tử null ??](#null-coalescing-operator)
  4. [Hàm (function)](#functions)
     * [Hàm nên có dưới 2 param](#function-arguments-2-or-fewer-ideally)
     * [Tên hàm nên nói lên hàm làm gì](#function-names-should-say-what-they-do)
...
### Dùng tên có nghĩa và đánh vần được
...
### Dùng cùng ngữ pháp cho cùng kiểu biến
...
### Sử dụng tên search được (phần 1)
...
### Sử dụng tên search được (phần 2)
...
### Sử dụng tên biến tự giải thích
...
### Hạn chế code nhiều tầng, nên return sớm (phần 1)
...
### Hạn chế code nhiều tầng, nên return sớm (phần 2)
...
### Tránh đặt tên biến khó hiểu (hơi giống cái tên biến tự giải thích)
...
### Nên dùng đối số (argument) mặc định, kết hợp với kiểu dữ liệu
...
### Tên hàm nên nói lên hàm làm gì
